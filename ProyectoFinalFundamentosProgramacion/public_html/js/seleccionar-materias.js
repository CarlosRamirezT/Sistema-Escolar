...
function crearTabla(){
    ...
    var cuatrimestreIngresado = parseInt(prompt("Ingrese el cuatrimestre a seleccionar: "));
    ...
    if(pemsunSoftware.length === 0){
        ...
        var celda = document.createElement("th");
        var textoCelda = document.createTextNode("Seleccionar");
        celda.appendChild(textoCelda);
        fila.appendChild(celda);
        ...
        for (var i = 0; i < pemsunSoftware.length; i++) {
            ...
            if(pemsunSoftware[i].cuatrimestre === cuatrimestreIngresado){
                ...
                /* boton para seleccionar la materia */

                var button = document.createElement("button");
                button.type = "button";
                button.innerText = "Seleccionar " + pemsunSoftware[i].codigo;
                var celda = document.createElement("td");
                celda.appendChild(button);
                fila.appendChild(celda);

                /* añadiendo la fila al cuerpo de la tabla */
